...
;; Created: 21 Nov 2017
;; Package-Version: 20250113.131
;; Package-Revision: 97f57d68f09c
;; Keywords: games
...
(defcustom elcord-idle-timer 600000
...
(defcustom elcord-mode-text-alist '((agda-mode . "Agda")
                                    ...
                                    (bqn-mode . "BQN")
                                    (c-mode . "Language of The Gods  ")
                                    (c++-mode . "Overly Complex C")
                                    (csharp-mode . "Microsoft Bullshit")
                                    (cperl-mode . "How old am I?")
                                    (elixir-mode . "Supercell TM ")
                                    (enh-ruby-mode . "Ruby")
                                    (erlang-mode . "Erlang")
                                    (fsharp-mode . "F#")
                                    ...
                                    (typescript-mode . "Corporate wants you to write in this language")
                                    (php-mode "MJC Time"))
